    ...
    view->open( n = `View` ns = `mvc`
                a = VALUE #( ( `xmlns=sap.m` )
                 ...
                 a = VALUE #( ( `class=sapUiSmallMargin` ) )
                     ...
                     a = VALUE #( ( `text=` &&
                                    `Lorem ipsum dolor st amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. ` &&
